        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-sm text-gray-500">
              Your trusted partner for business consultancy and financial services in Hyderabad.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              {quickLinks.map((link, index) => (
                <li key={index}>
                  <a href={link.href} className="text-gray-400 hover:text-accent-400 transition-colors duration-200 text-sm">
                    {link.label}
                  </a>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start space-x-3">
                ...
                <span className="text-sm text-gray-400">
                  <a href="https://wa.me/919133213033" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors">91332 13033</a>
                  {' / '}
                  <a href="https://wa.me/917386111332" target="_blank" rel="noopener noreferrer" className="hover:text-green-400 transition-colors">73861 11332</a>
                </span>
              </li>
              <li>
                <a href="mailto:listeningleafpl@gmail.com" className="flex items-center space-x-3 group">
                  ...
                  <span className="text-sm text-gray-400 group-hover:text-accent-400 transition-colors">listeningleafpl@gmail.com</span>
                </a>
              </li>
            </ul>
          </div>
      ...
      <div className="border-t border-gray-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <p className="text-sm text-gray-500">
              &copy; {new Date().getFullYear()} Listening Leaf Private Limited. All rights reserved.
            </p>
            <p className="text-sm text-gray-500">
              We Make It Possible
            </p>
