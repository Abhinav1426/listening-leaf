          ...
          <div className="relative">
            ...
            <div className="relative bg-white rounded-3xl shadow-2xl overflow-hidden">
              ...
              <div className="gradient-bg px-8 py-6">
                ...
                <p className="text-primary-200 mt-1 text-sm">Dedicated professionals at your service</p>
              </div>
              ...
              <div className="p-8 space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-800">Chartered Accountants</h4>
                    <p className="text-sm text-gray-500">Expert financial advisors</p>
                  </div>
                </div>

                <div className="flex items-center space-x-4">
                  <div className="w-14 h-14 rounded-full bg-accent-500 flex items-center justify-center flex-shrink-0">
                    <span className="text-white font-bold text-sm">FP</span>
                  </div>
                  <div>
                    <h4 className="font-semibold text-primary-800">Finance Professionals</h4>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    <h4 className="font-semibold text-primary-800">Talented Managers</h4>
                ...
                {/* Vision Quote */}
                <div className="mt-10 p-6 bg-accent-50 rounded-xl border-l-4 border-accent-500">
                  ...
                  <p className="text-xs text-accent-600 font-medium mt-2">Yerasi Chaitanya Reddy <br /> Founder</p>
                </div>
              </div>
            </div>
          </div>
